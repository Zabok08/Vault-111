...
const permissions: Record<AppRole, Set<string>> = {
  ...
  OC_PLANNER: new Set(["oc.read", "oc.sync", "oc.assign", "oc.optimize", "war.read", "war.payout.read"]),
  WAR_MANAGER: new Set(["oc.read", "war.read", "war.sync", "war.manage", "war.notes", "war.payout.read", "war.payout.manage"]),
  OFFICER: new Set(["oc.read", "war.read", "war.notes", "war.payout.read"]),
  MEMBER: new Set(["oc.read", "war.read", "war.payout.read"])
};
