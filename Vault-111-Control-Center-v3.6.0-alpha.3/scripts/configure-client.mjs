...
const sourcePath = resolve("client/Vault-111-Control-Center-v3.6.0-alpha.3.user.js");
const outputPath = resolve(
  process.argv[3] || "client/Vault-111-Control-Center-v3.6.0-alpha.3-production.user.js"
);
