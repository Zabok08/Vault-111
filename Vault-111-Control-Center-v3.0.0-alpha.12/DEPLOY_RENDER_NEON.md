...
```json
{"ok":true,"version":"3.0.0-alpha.12","database":"connected"}
```
...
```text
client/Vault-111-Control-Center-v3.0.0-alpha.12-production.user.js
```
