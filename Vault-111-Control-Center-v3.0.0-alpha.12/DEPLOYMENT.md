...
Install the resulting `client/Vault-111-Control-Center-v3.0.0-alpha.12-production.user.js`. The generator adds only the exact backend hostname to `@connect`; it does not use a wildcard or include secrets.
