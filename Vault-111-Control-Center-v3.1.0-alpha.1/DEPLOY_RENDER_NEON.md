...
```json
{"ok":true,"version":"3.1.0-alpha.1","database":"connected"}
```
...
```text
client/Vault-111-Control-Center-v3.1.0-alpha.1-production.user.js
```
