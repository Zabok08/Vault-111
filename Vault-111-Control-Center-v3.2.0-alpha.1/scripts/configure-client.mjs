...
const sourcePath = resolve("client/Vault-111-Control-Center-v3.2.0-alpha.1.user.js");
const outputPath = resolve(
  process.argv[3] || "client/Vault-111-Control-Center-v3.2.0-alpha.1-production.user.js"
);
