...
const sourcePath = resolve("client/Vault-111-Control-Center-v3.0.0-alpha.12.user.js");
const outputPath = resolve(
  process.argv[3] || "client/Vault-111-Control-Center-v3.0.0-alpha.12-production.user.js"
);
