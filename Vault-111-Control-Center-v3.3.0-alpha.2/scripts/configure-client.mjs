...
const sourcePath = resolve("client/Vault-111-Control-Center-v3.3.0-alpha.2.user.js");
const outputPath = resolve(
  process.argv[3] || "client/Vault-111-Control-Center-v3.3.0-alpha.2-production.user.js"
);
