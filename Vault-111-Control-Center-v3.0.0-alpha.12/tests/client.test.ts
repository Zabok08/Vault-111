...
const client = readFileSync(
  resolve("client/Vault-111-Control-Center-v3.0.0-alpha.12.user.js"),
  "utf8"
);

describe("Tampermonkey release client", () => {
  it("includes the accessibility and motion safeguards required for alpha.12", () => {
  ...
  it("implements the requested alpha.12 UI and API-screen behavior", () => {
