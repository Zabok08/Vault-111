...
```json
{"ok":true,"version":"3.0.0-alpha.14","database":"connected"}
```
...
```text
client/Vault-111-Control-Center-v3.0.0-alpha.14-production.user.js
```
